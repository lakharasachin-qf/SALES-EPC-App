...
class AppPermissions {
  ...
  bool get canApproveLead => _rights['approve_lead'] ?? false; // NEW RIGHT
  ...
  /// Load rights from SharedPreferences (after login)
